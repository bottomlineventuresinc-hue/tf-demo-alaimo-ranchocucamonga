/* Template Factory - Jason Alaimo Electric live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-alaimo-ranchocucamonga/';
  var LS_CHANGES = 'tf_alaimo_change_log_v1';
  var LS_PURCHASED = 'tf_alaimo_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Residential electrical, panel upgrades, and wiring across Rancho Cucamonga and the Inland Empire. You get a fixed itemised quote before we start, Jason as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Jason at Jason Alaimo Electric. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Jason at Jason Alaimo Electric. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Jason Alaimo Electric. Hang tight.',
        delay,
        function () {
